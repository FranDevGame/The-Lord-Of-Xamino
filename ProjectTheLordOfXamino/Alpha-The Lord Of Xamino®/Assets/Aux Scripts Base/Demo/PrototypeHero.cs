...
public class PrototypeHero : MonoBehaviour
{
    ...
    [SerializeField] bool m_grounded = false;
    ...
    private Vector3 m_respawnPosition = new Vector3(-6f, 2f, 0);
    ...
    private void RestartPosition()
    {
        ...
        this.m_body2d.velocity = Vector2.zero;
    ...
    void Update()
    {
        ...
        if (PlayerLife.instance.currerntHealh == 0)
        {
            if (m_dead == true)
            {
            ...
            else if (PlayerLife.instance.currerntHealh == 0)
            {
                DeathKylan();

                Invoke("UploadLifeBeforeDeath", 2.4f);
            }
        }


        //// Parry & parry stance
        //if (Input.GetMouseButtonDown(1) && !m_dodging && !m_ledgeGrab && !m_ledgeClimb && !m_crouching && m_grounded)
        //{
        //    // Parry
    ...
    public void KylanAttack()
    {
         if (Input.GetMouseButtonDown(0) && !m_dodging && !m_ledgeGrab && !m_ledgeClimb && !m_crouching && m_grounded && m_timeSinceAttack > 0.2f)
        {
            // Reset timer
            m_timeSinceAttack = 0.0f;
    ...
    public void UploadLifeBeforeDeath()
    {
